...
//                 {summary.state || report.filters?.state || "-"}
//               </span>
//             </div>
...
//         <div>
//           <SectionLabel>Contamination breakdown</SectionLabel>
...
//         <div>
//           <SectionLabel>Registration and vendors</SectionLabel>
...
//         <div>
//           <SectionLabel>LGA breakdown</SectionLabel>
...
//               {topLgas.length > 0 ? (
//                 topLgas.map((item) => (
//                   <tr key={item.lgaName} className="hover:bg-gray-50">
